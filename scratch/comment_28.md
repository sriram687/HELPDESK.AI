Helo @arpan7sarkar! 🙌 (And open to @saurabhhhcodes, @namann5, @harshitanagpal05, @Anand-240, @tamannaa-rath, or any other contributors who want to collaborate in parallel!)
...
1. **Identify the Component**: Locate the website usage steps component in the pricing area on the landing page.
2. **Optimize Animations**: Inspect any Framer Motion or CSS animation transitions that trigger step updates. Optimize them (e.g. adjust delay/durations, reduce expensive repaints) to eliminate visual stutter and lag.
3. **Typography Audit**: Audit font sizes, weights, and font families used in the steps section and align them perfectly with the overall brand identity and global CSS theme variables.
